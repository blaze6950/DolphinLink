...
// WebSerial interop module for DolphinLink.WebSerial.
//
...
//   DolphinLink.WebSerial.WebSerialInterop.OnData(portId, Uint8Array)
 ...
 *
 * @param {string} assemblyName - The DLL name, e.g. "DolphinLink.WebSerial.dll"
...
export async function initModule(assemblyName) {
    ...
    _onDataExport =
        exports['DolphinLink']['SerialPort']['WebSerial']['WebSerialInterop']['OnData'];
}
