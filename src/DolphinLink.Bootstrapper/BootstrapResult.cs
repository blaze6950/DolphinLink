...
/// <summary>
/// What the bootstrapper did during a successful <see cref="Bootstrapper.BootstrapAsync"/> call.
/// </summary>
...
/// <summary>
/// The result of a successful <see cref="Bootstrapper.BootstrapAsync"/> call.
...
{
    /// <summary>
    /// A fully connected and negotiated <see cref="RpcClient"/> ready for use.
    /// </summary>
...
{
    /// <summary>
    /// The action that would have been taken if <see cref="BootstrapOptions.AutoInstall"/>
    /// had been <c>true</c>, or <c>null</c> if the failure is unrelated to install policy.
    /// </summary>
    public BootstrapAction? RequiredAction { get; }

    internal BootstrapException(string message, BootstrapAction? requiredAction = null)
        : base(message)
    {
        RequiredAction = requiredAction;
    }

    internal BootstrapException(string message, Exception inner, BootstrapAction? requiredAction = null)
        : base(message, inner)
    {
        RequiredAction = requiredAction;
    }
