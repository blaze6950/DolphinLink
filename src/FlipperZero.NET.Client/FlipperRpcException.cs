...
public sealed class FlipperRpcException : Exception
{
    ...
    public FlipperRpcException(string message)
        : base(message) { }

    public FlipperRpcException(uint requestId, string errorCode)
    ...
    public FlipperRpcException(string message, Exception inner)
        : base(message, inner) { }
}
