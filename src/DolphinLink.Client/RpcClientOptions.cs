...
/// <summary>
    /// Connection-behaviour options for <see cref="RpcClient"/>.
    ///
    /// Both <c>default</c> and <c>new RpcClientOptions()</c> produce an
    ...
    /// new RpcClient(transport, new RpcClientOptions
    /// {
    ...
    /// </code>
    /// </summary>
    public readonly record struct RpcClientOptions
{
    ...
    /// multiple threads call <see cref="RpcClient.SendAsync{TCommand,TResponse}"/>
