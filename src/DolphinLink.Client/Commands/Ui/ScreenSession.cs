...
/// <see cref="Extensions.UiExtensions.UiScreenAcquireAsync"/>.
...
/// </code>
/// </summary>
public sealed class ScreenSession : IAsyncDisposable
{
    private readonly RpcClient _client;
    private int _disposed;

    internal ScreenSession(RpcClient client)
    {
        _client = client;
    }
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        catch (RpcException) { /* screen may already be released */ }
