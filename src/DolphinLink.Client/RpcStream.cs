...
/// exits with a <see cref="DisconnectedException"/> that describes why
    ...
    where TEvent : struct
{
    ...
    /// <see cref="RpcClient"/> can send <c>stream_close</c> without
        ...
        try
        {
            ...
            while (true)
            {
                    ...
                    !cancellationToken.IsCancellationRequested)
                {
                    ...
                    // The channel was already faulted with a DisconnectedException
