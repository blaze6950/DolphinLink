...
/// <summary>
/// Identifies the cause of a <see cref="DisconnectedException"/>.
/// </summary>
public enum DisconnectReason
{
    ...
    /// <summary>
    /// <see cref="RpcClient.DisposeAsync"/> was called while operations were in flight.
    /// </summary>
    ClientDisposed,
}
...
/// Subclass of <see cref="RpcException"/> so existing <c>catch (RpcException)</c>
...
/// <see cref="DisconnectedException"/> before the base <see cref="RpcException"/>.
/// </para>
/// </summary>
public sealed class DisconnectedException : RpcException
{
    ...
    public DisconnectedException(DisconnectReason reason, string message)
        : base(message)
    {
        Reason = reason;
    }
    ...
    public DisconnectedException(DisconnectReason reason, string message, Exception inner)
        : base(message, inner)
    {
        Reason = reason;
    }
