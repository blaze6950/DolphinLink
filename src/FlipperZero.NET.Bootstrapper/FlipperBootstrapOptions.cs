...
/// <summary>
/// Configuration options for <see cref="FlipperBootstrapper"/>.
///
...
/// </summary>
public readonly record struct FlipperBootstrapOptions
{
    // Backing fields let default(FlipperBootstrapOptions) resolve to sensible values.
    ...
    /// <see cref="FlipperBootstrapException"/> describes what action would have
    ...
    ///
    /// Defaults to <c>/ext/apps/Tools/flipper_zero_rpc_daemon.fap</c>.
    /// Intermediate directories are created automatically if they do not exist.
    /// </summary>
    public string InstallPath
    {
        get => _installPath ?? "/ext/apps/Tools/flipper_zero_rpc_daemon.fap";
