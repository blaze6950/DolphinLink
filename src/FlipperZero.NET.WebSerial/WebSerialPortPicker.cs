...
/// <list type="bullet">
///   <item>CDC 0 — system/native protobuf RPC (used by <c>FlipperBootstrapper</c>)</item>
///   <item>CDC 1 — daemon NDJSON RPC (used by <c>FlipperRpcClient</c>)</item>
/// </list>
/// </para>
///
/// <para>
...
///   <item>Run <c>FlipperBootstrapper.BootstrapAsync</c>.  In the
...
public static class WebSerialPortPicker
{
    ...
    ///
    /// <para>
    /// The system port is used by <c>FlipperBootstrapper</c> to upload and launch
    ...
    /// <c>FlipperBootstrapper.BootstrapAsync</c>, immediately after the native RPC
    ...
    /// await FlipperBootstrapper.BootstrapAsync(
    ///     ...
    ...
    /// <see cref="FlipperRpcClient"/> and call <c>ConnectAsync</c> with a short
    ...
    /// </param>
    /// <param name="clientOptions">Options forwarded to the <see cref="FlipperRpcClient"/>.</param>
