...
/// <summary>
/// Singleton service that owns the <see cref="FlipperRpcClient"/> and the entire
...
public sealed class FlipperClientService : IAsyncDisposable
{
    // ── Connected client ──────────────────────────────────────────────────────
    ...
    public FlipperRpcClient? Client => _client;
    ...
    private FlipperRpcClientOptions BuildClientOptions() => new()
    {
    ...
    public FlipperClientService(RpcConsoleService diagnostics)
    {
