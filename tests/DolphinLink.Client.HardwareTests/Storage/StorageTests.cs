...
namespace DolphinLink.Client.HardwareTests.Storage;

/// <summary>
/// Hardware tests for storage commands:
/// <see cref="RpcClient.StorageInfoAsync"/>,
/// <see cref="RpcClient.StorageListAsync"/>,
/// <see cref="RpcClient.StorageReadAsync"/>,
/// <see cref="RpcClient.StorageWriteAsync"/>,
/// <see cref="RpcClient.StorageMkdirAsync"/>,
/// <see cref="RpcClient.StorageRemoveAsync"/>, and
/// <see cref="RpcClient.StorageStatAsync"/>.
///
...
public sealed class StorageTests(DeviceFixture fixture)
{
    ...
    /// <see cref="RpcException"/> with the <c>storage_error</c>
    /// error code.
    ...
    /// <see cref="RpcException"/> with the <c>open_failed</c> error
    /// code.
    ...
    /// <see cref="RpcException"/> with the <c>mkdir_failed</c> error
    /// code.
    ...
    /// <summary>
    /// Stating a non-existent path must throw a <see cref="RpcException"/>
    ...
    /// <summary>
    /// Removing a non-existent path must throw a <see cref="RpcException"/>
    ...
    /// <summary>
    /// Reading a non-existent file must throw a <see cref="RpcException"/>
