...
/// <summary>
/// Hardware tests for IR transmit commands:
/// <see cref="RpcClient.IrTxAsync"/> and
/// <see cref="RpcClient.IrTxRawAsync"/>.
///
...
public sealed class IrTxTests(DeviceFixture fixture)
{
    ...
    /// <see cref="RpcException"/> with the <c>unknown_protocol</c>
    /// error code.
    ...
    /// <see cref="RpcException"/> because the daemon's
