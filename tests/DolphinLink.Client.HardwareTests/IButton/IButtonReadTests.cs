...
namespace DolphinLink.Client.HardwareTests.IButton;

/// <summary>
/// Hardware tests for iButton streaming via
/// <see cref="RpcClient.IbuttonReadStartAsync"/>.
...
public sealed class IButtonReadTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.IbuttonReadStartAsync"/> must return an
