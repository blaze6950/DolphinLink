...
/// <see cref="RpcClient.StreamCloseAsync"/>.
///
...
public sealed class StreamCloseTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// Explicitly closing a stream by id via
    /// <see cref="RpcClient.StreamCloseAsync"/> must succeed without
    /// throwing.
    ...
    /// return a <see cref="RpcException"/> with the
