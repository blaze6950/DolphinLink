namespace DolphinLink.Client.HardwareTests.Input;

/// <summary>
/// Hardware tests for the <c>input_listen_start</c> stream command via
/// <see cref="InputExtensions.InputListenStartAsync"/>.
...
public sealed class InputListenTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="InputExtensions.InputListenStartAsync"/> must return an
