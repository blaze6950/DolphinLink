...
namespace DolphinLink.Client.HardwareTests.Rfid;

/// <summary>
/// Hardware tests for LF RFID streaming via
/// <see cref="RpcClient.LfrfidReadStartAsync"/>.
...
public sealed class LfRfidReadTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.LfrfidReadStartAsync"/> must return an
