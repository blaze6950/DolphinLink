...
namespace DolphinLink.Client.HardwareTests.SubGhz;

/// <summary>
/// Hardware tests for Sub-GHz RX streaming via <see cref="RpcClient.SubghzRxStartAsync"/>.
...
public sealed class SubGhzRxTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.SubghzRxStartAsync"/> with no explicit
