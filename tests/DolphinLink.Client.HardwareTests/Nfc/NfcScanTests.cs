...
namespace DolphinLink.Client.HardwareTests.Nfc;

/// <summary>
/// Hardware tests for NFC scanning via <see cref="RpcClient.NfcScanStartAsync"/>.
...
public sealed class NfcScanTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.NfcScanStartAsync"/> must return an
