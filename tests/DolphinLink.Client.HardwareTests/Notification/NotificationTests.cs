...
namespace DolphinLink.Client.HardwareTests.Notification;

/// <summary>
/// Hardware tests for notification commands:
/// <see cref="RpcClient.LedSetAsync"/>,
/// <see cref="RpcClient.LedSetRgbAsync"/>,
/// <see cref="RpcClient.VibroAsync"/>,
/// <see cref="RpcClient.SpeakerStartAsync"/>,
/// <see cref="RpcClient.SpeakerStopAsync"/>, and
/// <see cref="RpcClient.BacklightAsync"/>.
/// Excludes manual scenario tests (<c>LedColorMelodyScenario</c>,
/// <c>LedComplexCheckScenario</c>) which require visual inspection.
///
...
public sealed class NotificationTests(DeviceFixture fixture)
{
    ...
    /// active must throw a <see cref="RpcException"/> with the
