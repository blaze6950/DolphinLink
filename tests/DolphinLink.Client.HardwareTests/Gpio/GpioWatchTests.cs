...
/// <summary>
/// Hardware tests for GPIO watch streaming via <see cref="RpcClient.GpioWatchStartAsync"/>.
///
...
public sealed class GpioWatchTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.GpioWatchStartAsync"/> must return an
