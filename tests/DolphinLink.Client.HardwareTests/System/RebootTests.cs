...
/// <summary>
/// Hardware tests for <see cref="Extensions.SystemExtensions.RebootAsync"/>.
///
...
public sealed class RebootTests
{
    ...
    /// <summary>
    /// <see cref="Extensions.SystemExtensions.RebootAsync"/> must return an OK
    ...
    /// <summary>
    /// After <see cref="Extensions.SystemExtensions.RebootAsync"/> returns, the
    /// <see cref="RpcClient.Disconnected"/> token must eventually be
    ...
    /// and calls <see cref="RpcClient.FaultAll"/>, which cancels
    /// <see cref="RpcClient.Disconnected"/>.
    /// </summary>
    [Trait("Category", "Hardware")]
    [RequiresDeviceFact]
