...
/// <summary>
/// Integration tests for <see cref="RpcClient.DatetimeGetAsync"/> and
/// <see cref="RpcClient.DatetimeSetAsync"/>.
///
...
public sealed class DatetimeTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.DatetimeGetAsync"/> must return a
