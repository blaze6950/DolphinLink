...
/// <summary>
/// Integration tests for <see cref="RpcClient.DeviceInfoAsync"/>.
///
...
public sealed class DeviceInfoTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.DeviceInfoAsync"/> must round-trip and
    ...
    /// <summary>
    /// Calling <see cref="RpcClient.DeviceInfoAsync"/> multiple times
