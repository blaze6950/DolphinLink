...
/// <summary>
/// Integration tests for <see cref="RpcClient.RegionInfoAsync"/> and
/// <see cref="RpcClient.FrequencyIsAllowedAsync"/>.
///
...
public sealed class RegionAndFrequencyTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="RpcClient.RegionInfoAsync"/> must return a non-empty
