...
/// <summary>
/// Integration tests for <see cref="Extensions.SystemExtensions.ConfigureAsync"/>.
///
...
public sealed class ConfigureTests(DeviceFixture fixture)
{
    private RpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="Extensions.SystemExtensions.ConfigureAsync"/> must echo back
    ...
    /// return a <see cref="RpcException"/> with error code
    ...
    /// must return a <see cref="RpcException"/> with error code
    /// <c>invalid_config</c>.
    ///
    ...
    /// by <see cref="RpcClient.ConnectAsync"/> to decide whether to send
