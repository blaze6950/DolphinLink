...
namespace DolphinLink.Client.UnitTests.Infrastructure;

/// <summary>
/// An in-process <see cref="ITransport"/> for unit tests.
///
/// Usage
/// -----
...
/// Heartbeat note
/// --------------
/// Use <see cref="CreateClient"/> (instead of <c>new RpcClient(transport)</c>)
...
public sealed class FakeTransport : ITransport
{
    ...
    /// <summary>
    /// Creates a <see cref="RpcClient"/> wrapping this transport with
    /// near-infinite heartbeat timing so the heartbeat loop never fires during
    /// tests.  Always prefer this over <c>new RpcClient(this)</c>.
    /// </summary>
    public RpcClient CreateClient(IRpcDiagnostics? diagnostics = null) =>
        new RpcClient(
            this,
