...
/// <summary>
/// Integration tests for <see cref="FlipperSystemExtensions.DaemonInfoAsync"/>.
///
...
public sealed class DaemonInfoTests(FlipperFixture fixture)
{
    private FlipperRpcClient Client => fixture.Client;

    /// <summary>
    /// <see cref="FlipperSystemExtensions.DaemonInfoAsync"/> must return the
    /// canonical daemon name <c>"flipper_zero_rpc_daemon"</c>.
    /// Validates: identity check used by <see cref="FlipperRpcClient.ConnectAsync"/>
    ...
    /// <summary>
    /// Calling <see cref="FlipperSystemExtensions.DaemonInfoAsync"/> multiple
